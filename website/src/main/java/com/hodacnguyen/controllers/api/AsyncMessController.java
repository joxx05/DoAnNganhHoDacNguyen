...
public class AsyncMessController {
    ...
    public ResponseEntity<List<Message>> listProducts(@PathVariable(name = "user1")int user1,@PathVariable(name = "user2")int user2){
        List<Message> mess=this.messageService.list(user1,user2);
