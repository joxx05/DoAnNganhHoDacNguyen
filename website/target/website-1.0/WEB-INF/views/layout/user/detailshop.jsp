        ...
        <div class="col-lg-4">
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="${baseURL}/myshop/statisproduct/${store.id}">Thống kê doanh thu sản phẩm</a>
                    <a class="dropdown-item" href="${baseURL}/myshop/statistype/${store.id}">Thống kê doanh thu loại sản phẩm</a>
